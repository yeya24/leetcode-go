...
func TestSubdomainVisitCount(t *testing.T) {
	...
	//		output: []string{"9001 leetcode.com", "9001 com", "9001 discuss.leetcode.com"},
	//	},
	//	{
	//		input:  []string{"900 google.mail.com", "50 yahoo.com", "1 intel.mail.com", "5 wiki.org"},
	//		output: []string{"901 mail.com", "951 com", "900 google.mail.com", "50 yahoo.com", "1 intel.mail.com", "5 org", "5 wiki.org"},
	//	},
	//}
	//for _, c := range cases {
	//	x := subdomainVisits(c.input)
